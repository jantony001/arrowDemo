...
var SumType = function (_Type4) {
    ...
    function SumType(names) {
        ...
        var _this25 = _possibleConstructorReturn(this, Object.getPrototypeOf(SumType).call(this));
...
var TaggedUnionType = function (_Type5) {
    ...
    function TaggedUnionType(map) {
        ...
        var _this26 = _possibleConstructorReturn(this, Object.getPrototypeOf(TaggedUnionType).call(this));

        _this26.vals = map;
        _this26.keys = Object.keys(map).sort();
        return _this26;
    }
    ...
    _createClass(TaggedUnionType, [{
        ...
        value: function equals(that) {
            ...
            if (that instanceof TaggedUnionType) {
                return this.keys.length === that.keys.length && this.keys.every(function (k) {
                    return _this27.vals[k].equals(that.vals[k]);
                });
            }
        ...
        value: function toString() {
            ...
            return '<' + this.keys.map(function (k) {
                return k + ': ' + _this28.vals[k].toString();
            }).join(', ') + '>';
        }
    }, {
        key: 'check',
        ...
        value: function isConcrete() {
            ...
            return this.keys.every(function (k) {
                return _this29.vals[k].isConcrete();
            });
        }
    }, {
        key: 'harvest',
        value: function harvest() {
            ...
            return this.keys.reduce(function (acc, k) {
                return acc.concat(_this30.vals[k].harvest());
            }, []);
        }
    }, {
        key: 'substitute',
        value: function substitute(map) {
            ...
            this.keys.forEach(function (k) {
                map[k] = _this31.vals[k].substitute(map);
            });
        ...
        value: function sanitize(map) {
            ...
            var vals = {};
            this.keys.forEach(function (k) {
                vals[k] = _this32.vals[k].sanitize(map);
            });
...
var ArrayType = function (_Type6) {
    ...
    function ArrayType(type) {
        ...
        var _this33 = _possibleConstructorReturn(this, Object.getPrototypeOf(ArrayType).call(this));
...
var TupleType = function (_Type7) {
    ...
    function TupleType(types) {
        ...
        var _this35 = _possibleConstructorReturn(this, Object.getPrototypeOf(TupleType).call(this));
        ...
        value: function check(value) {
            ...
            if (value && value.constructor === Array) {
                value.forEach(function (v, i) {
                    return _this36.types[i].check(v);
                });
            } else {
...
var RecordType = function (_Type8) {
    ...
    function RecordType(map) {
        ...
        var _this37 = _possibleConstructorReturn(this, Object.getPrototypeOf(RecordType).call(this));

        _this37.vals = map;
        _this37.keys = Object.keys(map).sort();
        return _this37;
    }
    ...
    _createClass(RecordType, [{
        ...
        value: function equals(that) {
            ...
            if (that instanceof RecordType) {
                return this.keys.length === that.keys.length && this.keys.every(function (k) {
                    return _this38.vals[k].equals(that.vals[k]);
                });
            }
        ...
        value: function toString() {
            ...
            return '{' + this.keys.map(function (k) {
                return k + ': ' + _this39.vals[k].toString();
            }).join(', ') + '}';
        }
    }, {
        key: 'check',
        ...
        value: function isConcrete() {
            ...
            return this.keys.every(function (k) {
                return _this41.vals[k].isConcrete();
            });
        }
    }, {
        key: 'harvest',
        value: function harvest() {
            ...
            return this.keys.reduce(function (acc, k) {
                return acc.concat(_this42.vals[k].harvest());
            }, []);
        }
    }, {
        key: 'substitute',
        value: function substitute(map) {
            ...
            var vals = {};
            this.keys.forEach(function (k) {
                vals[k] = _this43.vals[k].substitute(map);
            });
        ...
        value: function sanitize(map) {
            ...
            var vals = {};
            this.keys.forEach(function (k) {
                vals[k] = _this44.vals[k].sanitize(map);
            });
    ...
    function ArrowType(arg, out, constraints, errors) {
        ...
        try {
            var _loop = function _loop() {
                ...
                if (!_this46.errors.some(function (e) {
                    return e.equals(type);
                })) {
                    _this46.errors.push(type);
                }
            };
